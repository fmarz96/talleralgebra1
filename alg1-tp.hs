...
-- Casos:
-- nombresDeUsuarios ([(1, Franco Marziano), (2, Tomas Miguez), (3, Fermin Schlottmann)],[],[])
-- publicacionesQueLeGustanA ([(1, Franco Marziano), (2, Tomas Miguez), (3, Fermin Schlottmann)],[],[(1, "Hola", [(1, "Franco Marziano")])]) (1, "Franco Marziano")
